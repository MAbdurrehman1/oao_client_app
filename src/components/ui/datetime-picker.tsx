  ...
  (
    ...
    return (
      <Input
        ...
        className={cn(
          `
            h-auto w-[48px] rounded-md border-border !px-0 !py-s4 text-center
            font-mono text-base tabular-nums text-brand-color-black
            caret-transparent
            focus:bg-grey-50
...
const TimePicker = React.forwardRef<TimePickerRef, TimePickerProps>(
  (
    ...
    // make sure the parent date is in sync with new default date
    React.useEffect(() => {
      onChange?.(date)
      // we only care about first render
